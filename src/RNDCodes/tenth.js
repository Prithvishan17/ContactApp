        ...
        <SafeAreaView style={styles.container}>
            <ScrollView>
                    ...
                    <View style={styles.descriptionContainer}>
                        <Text style={styles.text}>Oh no !! You have been captured by the Ghost 👻 Click the button below to escape from the Ghost !!</Text>
                    </View>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => {
                            ...
                            analytics().logEvent('Ten_to_Twelve', { buttonName: '10_to_12' });

                            // Navigate to screen Twelve
                            navigation.navigate('Twelve')
                        }}
                        style={styles.buttonsContainer}>

                        <Image style={styles.btnImage} source={escape} />
