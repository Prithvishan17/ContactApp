        ...
        <SafeAreaView style={styles.container}>
            <ScrollView>
                ...
                <View style={styles.imageContainer}>
                    <Image source={five} style={styles.image} />
                </View>

                {/** Title Container **/}
                <View style={styles.titleContainer}>
                    <Text style={styles.text}>Welcome to Screen 5</Text>
                ...
                <View style={styles.buttonsContainer}>
                    <TouchableOpacity activeOpacity={0.4}
                        onPress={() => {
                            ...
                            analytics().logEvent('Fifth_Eight', { buttonName: 'Eight' });

                            // Navigate to the Eight screen
                            navigation.navigate('Eight')
                        }}
                    >
                        <Image source={eight} style={styles.btnImage} />
                    </TouchableOpacity>

                    <TouchableOpacity activeOpacity={0.4}
                        onPress={() => {
                            // Log an analytics event before navigating
                            analytics().logEvent('Fifth_Nine', { buttonName: 'Nine' });

                            // Navigate to the Nine screen
                            navigation.navigate('Nine')
                        }}>
                        <Image source={nine} style={styles.btnImage} />
                    </TouchableOpacity>

                    <TouchableOpacity activeOpacity={0.4}
                        onPress={() => {
                            // Log an analytics event before navigating
                            analytics().logEvent('Fifth_Ten', { buttonName: 'Ten' });

                            // Navigate to the Ten screen
                            navigation.navigate('Ten')
                        }}>
                        <Image source={ten} style={styles.btnImage} />
                    </TouchableOpacity>
                </View>
