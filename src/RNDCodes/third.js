        ...
        <SafeAreaView style={styles.container}>
            <ScrollView>
                ...
                <View style={styles.imageContainer}>
                    <Image source={three} style={styles.image} />
                </View>

                {/** Title Container **/}
                <View style={styles.titleContainer}>
                    <Text style={styles.text}>Welcome to Screen 3</Text>

                </View>

                {/** Description Container **/}
                <View style={styles.descriptionContainer}>
                    <Text style={styles.text}>Press the button below to navigate to screen 6</Text>
                ...
                <View style={styles.buttonsContainer}>
                    <TouchableOpacity activeOpacity={0.4}
                        onPress={() => {
                            ...
                            analytics().logEvent('Third_Sixth', { buttonName: 'Sixth' });

                            // Navigate to the Sixth screen
                            navigation.navigate('Sixth')
                        }}>
                        <Image source={six} style={styles.btnImage} />
                    </TouchableOpacity>
