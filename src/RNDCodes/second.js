        ...
        <SafeAreaView style={styles.container}>
            <ScrollView>
                ...
                <View style={styles.descriptionContainer}>
                    <Text style={styles.text}>Press the button below to navigate to screen 5</Text>
                ...
                <View style={styles.buttonsContainer}>
                    <TouchableOpacity activeOpacity={0.4}
                        onPress={() => {
                            ...
                            analytics().logEvent('Second_Fifth', { buttonName: 'Fifth' });

                            // Navigate to the Fifth screen
                            navigation.navigate('Fifth')
                        }}>
                        <Image source={five} style={styles.btnImage} />
                    </TouchableOpacity>
