        ...
        <SafeAreaView style={styles.container}>
            <ScrollView>
                ...
                <View style={styles.imageContainer}>
                    <Image source={seven} style={styles.image} />
                </View>

                {/** Title Container **/}
                <View style={styles.titleContainer}>
                    <Text style={styles.text}>Welcome to Screen 7</Text>
                ...
                <View style={styles.buttonsContainer}>
                    <TouchableOpacity activeOpacity={0.4}
                        onPress={() => {
                            ...
                            analytics().logEvent('Seventh_Fourteen', { buttonName: 'Fourteen' });

                            // Navigate to the Fourteen screen
                            navigation.navigate('Fourteen')
                        }}
                    >
                        <Image source={fourteen} style={styles.btnImage} />
                    </TouchableOpacity>

                    <TouchableOpacity activeOpacity={0.4}
                        onPress={() => {
                            // Log an analytics event before navigating
                            analytics().logEvent('Seventh_Fifteen', { buttonName: 'Fifteen' });

                            // Navigate to the Fifteen screen
                            navigation.navigate('Fifteen')
                        }}
                    >
                        <Image source={fifteen} style={styles.btnImage} />
                    </TouchableOpacity>

                    <TouchableOpacity activeOpacity={0.4}
                        onPress={() => {
                            // Log an analytics event before navigating
                            analytics().logEvent('Seventh_Sixteen', { buttonName: 'Sixteen' });

                            // Navigate to the Sixteen screen
                            navigation.navigate('Sixteen')
                        }}
                    >
                        <Image source={sixteen} style={styles.btnImage} />
                    </TouchableOpacity>
                </View>
