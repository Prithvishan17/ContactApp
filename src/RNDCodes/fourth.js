        ...
        <SafeAreaView style={styles.container}>
            <ScrollView>
                ...
                <View style={styles.imageContainer}>
                    <Image source={four} style={styles.image} />
                </View>

                {/** Title Container **/}
                <View style={styles.titleContainer}>
                    <Text style={styles.text}>Welcome to Screen 4</Text>

                </View>

                {/** Description Container **/}
                <View style={styles.descriptionContainer}>
                    <Text style={styles.text}>Press the button below to navigate to screen 7</Text>
                ...
                <View style={styles.buttonsContainer}>
                    <TouchableOpacity activeOpacity={0.4}
                        onPress={() => {
                            ...
                            analytics().logEvent('Fourth_Seventh', { buttonName: 'Seventh' });

                            // Navigate to the Seventh screen
                            navigation.navigate('Seventh')
                        }}
                    >
                        <Image source={seven} style={styles.btnImage} />
                    </TouchableOpacity>
