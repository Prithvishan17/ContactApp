...
/**  CONTACTS APP VERSION 2  **/

// import React, { useState, useEffect, useRef } from 'react';
// import { View, Text, StyleSheet, TouchableOpacity, FlatList, SectionList, Dimensions, Image, Alert, TextInput } from 'react-native';
// import { SafeAreaView } from 'react-native-safe-area-context';
// import firestore from '@react-native-firebase/firestore';
...
//     const [sections, setSections] = useState([]);
//     const [alfabet, setAlfabet] = useState([]);
//     const [refreshData, setRefreshData] = useState(false); // State variable for data refreshing
//     const [selectedCategory, setSelectedCategory] = useState(null);
...
//                     // Print the document ID to the console
...
//                 const docIdArray = Object.keys(tempID).map((key) => ({
//                     ID: key,
//                 }));

//                 setSections(sectionsArray); //Section List Data
//                 setAlfabet(alfebetArray); //Flat List Data
//                 setRefreshData(false); //Reset the refresh state
...
//             {/* <View style={{ flexDirection: 'row', marginHorizontal: 10, marginBottom: 10, justifyContent: 'space-between', backgroundColor: 'teal' }}>

//                 <TouchableOpacity onPress={handleRefreshData}>
//                     <Image
//                         source={{ uri: 'https://cdn-icons-png.flaticon.com/128/3161/3161390.png' }}
//                         style={styles.image} />
//                 </TouchableOpacity>
...
//             <View style={{ flex: 1, flexDirection: 'row', backgroundColor: 'crimson', marginLeft: 12 }}>
...
// import React, { useState, useEffect, useRef } from 'react';
// import { View, Text, StyleSheet, TouchableOpacity, FlatList, SectionList, Dimensions, Image, Alert, TextInput, ImageBackground } from 'react-native';
// import { SafeAreaView } from 'react-native-safe-area-context';
// import firestore from '@react-native-firebase/firestore';
